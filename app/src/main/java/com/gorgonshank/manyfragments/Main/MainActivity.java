...
public class MainActivity extends FragmentActivity {
    ...
    private class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        // Set titles for tabs
        private String tabtitles[] = new String[] {"Character Screen 1", "Barcode","Equipped Fragment","Equipment Fragment"};
        ...
        public Fragment getItem(int pos) {
            switch(pos) {
                ...
                case 2: return EquippedFragment.newInstance("EquippedFragment");
                case 3: return SecondFragment.newInstance("SecondFragment");
